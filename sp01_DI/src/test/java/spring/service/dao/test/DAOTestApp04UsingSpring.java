...
public class DAOTestApp04UsingSpring {
	...
	public static void main(String[] args) {
		// MemberDAOImpl 를 여기서 직접 생성하면 재사용성이 떨어진다.
		//직접 연결되어있다는 것은  Coupling이 Tight하다는 의미
		...
		dao.delete("haha0071"); //코드에 new 키워드가 사라졌다. / 실체클래스명(MemberDAOImpl)이 보이지 않고 인터페이스로 소통하고 있다
	}
